...
const CHASSIS_ANGULAR_DAMPING = 0.5;  // Passive body-level damping (base layer); righting spring/damper handles anti-flip
...
export function createHeadlessRace(
  ...
  // Chassis above wheel (lower Y = above in Y-down)
