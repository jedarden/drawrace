...
console.log("\n" + "=".repeat(120));
console.log("MOTOR_SPEED Sign Comparison");
console.log("=".repeat(120));
console.log("\nTo confirm motor direction, we need to run with MOTOR_SPEED=-8 (sign-flipped).");
console.log("This requires modifying race-sim.ts MOTOR_SPEED constant or adding a test variant.");
console.log("\nExpected behavior with current code (MOTOR_SPEED=8):");
console.log("  - Positive ω should drive car forward (+X direction)");
console.log("  - If ω is positive but car moves backward (-X), sign convention is inverted");
console.log("  - If ω is negative and car moves backward, MOTOR_SPEED=-8 would fix it");
